...
export const navbarStyles = {
  /* MAIN NAVBAR */
  navbarContainer:
    "sticky top-0 z-50 bg-white/95 backdrop-blur-md border-b border-emerald-100 shadow-sm transition-all duration-300",

  navbarBorder:
    "h-[2px] w-full bg-gradient-to-r from-emerald-400 via-green-500 to-emerald-400",
  ...
  logoImageWrapper: "w-14 h-14 flex items-center justify-center",
  logoImage: "w-full h-full object-contain",
  logoTextContainer: "flex flex-col",
  logoTitle:
    "text-xl font-bold bg-gradient-to-r from-emerald-600 to-green-600 bg-clip-text text-transparent",
  ...
  navItemsContainer:
    "flex items-center gap-8 bg-white border border-emerald-200 px-6 py-2 rounded-full shadow-md",
  ...
  doctorAdminButton:
    "hidden lg:flex items-center gap-2 text-sm font-semibold text-gray-700 hover:text-emerald-600",

  doctorAdminIcon: "w-4 h-4",
  doctorAdminText: "hidden lg:inline",

  loginButton:
    "hidden lg:flex items-center gap-2 bg-gradient-to-r from-emerald-500 to-green-600 text-white px-5 py-2 rounded-full font-semibold hover:shadow-lg transition",

  loginIcon: "w-4 h-4",

  toggleIcon:
    "w-6 h-6 lg:hidden cursor-pointer text-gray-800",

  /* ✅ MOBILE MENU FIXED */
 /* MOBILE MENU */
mobileMenu:
  "lg:hidden border-t border-emerald-100 bg-white px-6 py-4 space-y-3",

mobileNavItem:
  "block w-full px-4 py-3 rounded-lg text-sm font-semibold transition-all",

activeMobileNavItemActive:
  "bg-emerald-600 text-white",

activeMobileNavItemInactive:
  "text-gray-700 hover:bg-emerald-50",

/* MOBILE BUTTONS */
mobileDoctorAdminButton:
  "w-full flex items-center justify-center gap-2 py-3 rounded-lg border border-emerald-200 bg-white text-sm font-semibold hover:bg-emerald-50 transition",

mobileLoginContainer:
  "w-full mt-3",

mobileLoginButton:
  "w-full flex items-center justify-center gap-2 bg-emerald-600 text-white py-3 rounded-lg font-semibold hover:bg-emerald-700 transition",
};
// Add to existing dummyStyles.js
